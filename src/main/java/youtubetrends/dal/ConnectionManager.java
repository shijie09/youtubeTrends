 ...
 * 8.0\mysql-connector-java-8.0.16-bin.jar B. If you already have a Java project created, then go to
...
public class ConnectionManager {
  ...
  private final String password = "Luoyang108";
  ...
  private final String schema = "youtubetrends";
